...
const ReflectiveCard = ({
  ...
  className = '',
  style = {},
  /* content + behavior (Xecrex): real identity data, camera strictly opt-in */
  enableCamera = false,
  badgeLabel = 'Secure access',
  name = 'Xecrex console',
  role = 'High integrity mode',
  idLabel = 'Build',
  ...
  return (
    <div className={`reflective-card-container ${className}`} style={{ ...style, ...cssVariables }}>
      ...
      {enableCamera && <video ref={videoRef} autoPlay playsInline muted className="reflective-video" />}
