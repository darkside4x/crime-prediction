      ...
      <p className="muted">
        {hostedLogin
          ...
          : import.meta.env.PROD
            ? "Paste a short-lived identity token issued by the configured identity provider. Roles and tenant access are resolved by the server, never the browser."
        ...
        <>
          ...
          <form onSubmit={(event) => submit(event, token, "Custom token")} className="token-form">
            ...
            <input
              ...
              placeholder={import.meta.env.PROD ? "Paste an identity token" : "demo-token-one"}
            />
